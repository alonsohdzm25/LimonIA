...
public final class ActivityInfoBinding implements ViewBinding {
  ...
  private ActivityInfoBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout containerEmail, @NonNull ImageView imageView,
  ...
  public static ActivityInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout containerEmail = rootView.findViewById(id);
      ...
      return new ActivityInfoBinding((ConstraintLayout) rootView, containerEmail, imageView,
          txtAppName);
    }
