...
public final class ActivityFaqBinding implements ViewBinding {
  ...
  private ActivityFaqBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
      @NonNull TextView txtFaq) {
  ...
  public static ActivityFaqBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txtFaq;
      TextView txtFaq = rootView.findViewById(id);
      if (txtFaq == null) {
        break missingId;
      }

      return new ActivityFaqBinding((ConstraintLayout) rootView, imageView, txtFaq);
    }
